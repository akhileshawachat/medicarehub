...
const {userState, updateState} =useUserContext();
   ...
   return (
       ...
       <Form onSubmit={handleSubmit}  style={{width:'400px',paddingTop:'100px'}}>
                       ...
                       <Row>
                           <Col>
                               ...
                               <Form.Group className="mb-3" controlId="formBasicPassword">
                                   ...
                                   <Form.Control disabled type="date" placeholder="Enter AppointmentDate" name="appdate" value={formData?.appdate} onChange={handleChange} required />
                               </Form.Group>
                           </Col>
                           <Col>
                               <Form.Group className="mb-3" controlId="formBasicPassword">
                                   <Form.Label><b>Appointment Time</b></Form.Label>
                                   <Form.Control disabled as="select" name="apptime" value={formData?.apptime} onChange={handleChange} required>
                       ...
                       <Form.Group className="mb-3" controlId="formBasicPassword">
                           <Form.Label><b>Prescription</b></Form.Label>
                           <Form.Control type="textarea" placeholder="Enter prescription" name="prescription" value={formData?.prescription} onChange={handleChange} required />
                       </Form.Group>
                       <Row>
